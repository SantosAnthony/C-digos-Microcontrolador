...
from PyQt6.QtGui import QFont, QDoubleValidator,QIcon,QFontDatabase
...
class Interface(QWidget):
    def __init__(self):
        ...
        font_id = QFontDatabase.addApplicationFont("Font/Poppins.ttf")
        
        if font_id == -1:
            print("Erro: A fonte não pôde ser carregada.")
            font_family = "Arial"
        else:
    ...
    def inicarInterface(self):
        self.setWindowTitle("HydroGen CSV")
        self.setWindowIcon(QIcon("5916453.png"))
